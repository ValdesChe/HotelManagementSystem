...
public class ComptableFilter extends AbstractFilter implements Filter {
    public void destroy() {
    }
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws ServletException, IOException {
        try{
            ...
            if( session != null && user != null ){
                System.out.println("++++++++++");
                System.out.println("--- COMPTABLE FILTER DETECT USER-");
                System.out.println("++++++++++");
                if(user.isComptable() && reqURI.contains("comptable")){
                ...
                System.out.println("++++++++++");
                System.out.println("--- CHAIN FILTER ON COMPTABLE-");
                System.out.println("++++++++++");
